...
//
// This deliberately always scales to exactly fit the window width, with no
// minimum — on a narrow window or phone, text/buttons do get small, but
// nothing ever needs horizontal scrolling or clips off-screen. A readable-
// minimum-zoom-plus-scroll variant was tried and reverted: it fixed the
// "too small on a phone" complaint but introduced a worse one (scrollbars
// and cut-off content on an ordinary resized desktop window), so exact-fit
// won out as the simpler, more universally correct behavior.
